function [Controls_u,target_theta,new_Pid_I]=flat_state1control(Model_consts,State_variables,solutions_dd,Pid_Is)
    Controls_u=[0,0];
    ...
    %Start for PID controls.

    Kp = 500;   % Proportional gain
    Ki = 100;
    Kd =5; % Derivative gain
    error = COM_x-Model_consts('r')*;
    
    % Proportional term
    P = Kp * error;
    
    new_Pid_I=Pid_Is('S1')+error*Model_consts('dt');
    I = Ki*new_Pid_I;
    % Derivative term
