function [t,COMs,COMvs,betas,thetas,target_thetas,controller_state_his,State_variables_his,Model_consts]=main_3_noised(init_state)
    ...
    switch controller_state
        ...
        case 3
            if abs(COM_x)<0.042
                [Controls_u,t_theta,new_Pid_I]=state3control(Model_consts,State_variables,solutions_dd,Pid_Is);
                Pid_Is('S3')=new_Pid_I;
                if abs(State_variables(3)-State_variables(2)-init_State_variables(3)+init_State_variables(2))<0.1
                    controller_state=1;
                end
            else 
                [Controls_u,t_theta,new_Pid_I]=state2control(Model_consts,State_variables,solutions_dd,Pid_Is);
