function [Controls_u,target_theta]=state2control(Model_consts,State_variables,solutions_dd)
    Controls_u=[0,0];
    ...
    target_a=-K*[COM_x;State_variables(6)];
    ...
    (double(subs(tau_1_sol,values)));
    Controls_u(1)=double(subs(tau_1_sol(2),values));
